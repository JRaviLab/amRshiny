...
**amR_shiny** is an interactive Shiny dashboard for exploring antimicrobial resistance (AMR) data and machine learning model results.
...
Report bugs and request features at: https://github.com/JRaviLab/amR_shiny/issues

## Related projects

- [amR_data](https://github.com/JRaviLab/amR_data): Data preparation pipeline
...
Please note that the amR_shiny project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md). By contributing to this project, you agree to abide by its terms.
